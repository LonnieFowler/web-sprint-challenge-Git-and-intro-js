...
function get20s(array) {
  ...
  for(let i=0; i<array.length; i++){
    ...
    if(parseInt(yearsArray[0]) >= 1900 && parseInt(yearsArray[2]) <= 2000){
      deadPeople.push(array[i].name)
    }
  }
  return deadPeople;
}
...
function addArtist(array) {
  array.push({ 
    ...
    bio: 'I like candy, and hugs and long walks on the beach. Kittens make me sneeze.'
  });
  return array;
}
